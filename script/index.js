...
>>>>>>> 110934fc58e3ab4b903f3ce9390910de4cb75a4e
};
...
=======
  ...
  let newHist = [];
  newHist.push(`O texto que você vai ler agora conta a história de ${personagem}, ${
    this.tipoPersonagem
  }, em uma aventura de outro mundo...

        “[...]Era por volta do ano de ${date.getFullYear()}, perto das três da madrugada, ${
    this.evento
  } enlouqueceu os cachorros de toda a redondeza.
         Os animais uivavam desesperadamente e corriam de um lado para o outro!
        Pareciam ter sentido vibrações que somente eles captam e os homens jamais percebem.
        A louca sinfonia canina atravessou as fronteiras ${
          this.place
        } e se espalhou em ondas por todo o horizonte.
        ${personagem} pegou ${
    this.arma
  } e foi lá fora ver o que poderia ser. Foi então que ele avistou três silhuetas assustadoras. Não teve dúvida de que se tratava de ${
    this.ficcao
  },
         como os imaginados pelos artistas de histórias e renomados pintores. Aqueles ${
           this.ficcao
         } assemelhavam-se a ${
    this.aparencia
  }. Ao se aproximarem, varreram a cerração com a força de seus movimentos, abrindo uma enorme clareira na vegetação ao redor de onde pararam.
