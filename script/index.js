...
function makeText() {
    ...
    newHist.push(`O texto que você vai ler agora conta a história de ${personagem}, ${this.tipoPersonagem}, em uma aventura de outro mundo...
        ...
        “[...]Era por volta do ano de ${date.getFullYear()}, perto das três da madrugada, ${this.evento} enlouqueceu os cachorros de toda a redondeza.
        ...
        A louca sinfonia canina atravessou as fronteiras ${this.place} e se espalhou em ondas por todo o horizonte.
        ...
        Seis ${this.ficcao}, com seus olhos fixos no nosso herói, o cercaram. Avançaram então na direção dele e ${personagem} apavorado e tremendo de medo, 
    ...
    function typeWriter(elemento) {
        ...
        for (let i = 0; i < newHist.length; i++) {
            setTimeout(() => elemento.innerHTML += newHist[i], 75 * i);
